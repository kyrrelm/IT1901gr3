 ...
 * and its logic after Login.
 * A lot of the code is autogenerated by Netbeans, and
 * is therfor not documented in detail. It does however
 * only generate the graphical part of the interface.
 * @author Kyrre
 * @author Kenneth
 */
...
//        );
	...
	/**
	 * This method is called when the user presses add farm.
	 * It creates a new farm in the Database, as well as updating
	 * the Farm list <List> in client.ServerData
	 * If farm name is less than 3 chars, the user will be prompted
	...
	/**
	 * This method is called when the user presses remove farm.
	 * It removes the given farm in the Database, as well as updating
	 * the Farm list <List> in client.ServerData
	 * @param evt
	 */
	...
	/**
	 * This method is called when the user presses add sheep.
	 * It adds a sheep to the Database, as well as updating
	 * the Sheep list <List> in client.ServerData
	 * @param evt
	 */
	...
	/**
	 * This method is called when the user presses remove sheep.
	 * It removes the given sheep from the Database, as well as updating
	 * the Sheep list <List> in client.ServerData
	 * @param evt
	 */
	...
	/**
	 * @author Kyrre
	 * Flips the boolean onlyAlarm every time the
	 * alarm checkbox is checked or unchecked.
	 * @param evt
	 */
	...
	/**
	 * @author Kyrre
	 * Filters the list of sheeps in the Map and Message pane,
	 * after the prefrences given in the form by 
	 * calling ServerData.filterMessages()
	 * @param evt
	 */
    ...
    */
	...
	/**
	 * initializes componens, and loads data needed
	 * for the hub.
	 */
	...
	/**
	 * Sets the top left icon of the JUnit
	 */
	...
	/**
	 * Sets the model for the combobox in the add sheep jPane
	 */
