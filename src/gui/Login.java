...
/**
 * Parts of this class is auto-generated by Netbeans
 * This class generate the GUI (Netbeans) of the Login,
 * and the logic for actual login thru the database.
 * @author Kyrre
 */
public class Login extends javax.swing.JFrame {
	 ...
	 * Promts users with error if server connection
	 ...
	 * If not, user is prompted with error.
	 * User is also prompted with error if server
